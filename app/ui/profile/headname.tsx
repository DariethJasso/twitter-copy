...
export default function HeadName({name}:{name:string}){
    return(
        <div className=" bg-black flex justify-start text-white h-[50px]">
            <Link href={"/enter/main"} className=" flex items-center justify-center w-[40px] h-[40px] m-1 hover:bg-gray-500/20 rounded-full"><FontAwesomeIcon icon={faArrowLeft} /></Link>
